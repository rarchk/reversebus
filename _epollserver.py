...
def check_config(config_dict, logger):
	...
	bool1 = (type(config_dict['tcp_nagle']) == bool)
	bool2 = (type(config_dict['tcp_cork']) == bool)
	bool3 = (type(config_dict['listen_connections']) == int)
	bool4 = (type(config_dict['log']) == unicode)

	if not (bool1 and bool2 and bool3 and bool4):
